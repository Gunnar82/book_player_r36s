...
int main(int argc,char **argv)
{
 ...
 while(running){
  ...
  MediaKeyAction media_actions[16];int media_action_count=media_keys_poll(&media_keys,media_actions,16);if(media_action_count>0){last_activity=SDL_GetTicks();idle_timer_remaining_ms=idle_timer_minutes>0?(Uint32)idle_timer_minutes*60000U:0U;idle_timer_last_tick=SDL_GetTicks();}
