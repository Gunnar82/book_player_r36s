...
## 0.2 Entwicklungszweig

Ab **0.2.0-dev5** liegen die 0.2-Änderungen vollständig in den Quelldateien. Der frühere Patch-Stack wird nicht mehr beim Docker-Build angewendet. Damit entspricht das Source-Paket exakt dem Code, der kompiliert wird.

## ARM64-Build

DarkOS läuft auf AArch64. Der Entwicklungsbuild wird für `linux/arm64` erzeugt und verwendet auf dem Gerät die installierten AArch64-Systembibliotheken. Es wird kein eigener `lib/`-Ordner aus Docker mit ausgeliefert.
