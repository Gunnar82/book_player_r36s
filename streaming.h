...
typedef struct { char uuid[STREAM_UUID_LEN]; char name[STREAM_NAME_LEN]; char url[STREAM_URL_LEN]; char type[32]; char group[128]; char logo[STREAM_URL_LEN]; } StreamEntry;
enum { STREAM_CERT_NONE=0, STREAM_CERT_DOWNLOADS=1, STREAM_CERT_SEPARATE=2 };
